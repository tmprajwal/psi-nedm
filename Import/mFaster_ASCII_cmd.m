...
Print["(faster) Rawdata Directory:",fasDir="/home/prajwal/nEDM/rawdatap"];
...
maxCy=288;
For[i=150,i<=maxCy,i++,
Run[StringJoin["faster_disfast ",fasDir,"/",ToString[year],"/",IntegerString[month,10,2],"/",IntegerString[day,10,2],"/",IntegerString[runNum,10,6],"_UCNdet_",IntegerString[i,10,3],"_0001.fast.p1e1 -t 43 > ",AscDir,"/",IntegerString[runNum,10,6],"/",IntegerString[runNum,10,6],"_UCNdet_",IntegerString[i,10,3],"_0001.fast.ascii"]];
